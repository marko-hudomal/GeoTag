										...
										<br>
											<form action="<?php echo base_url()?>index.php/guest/login" method="POST">
											  <div class="form-group" style="width:60%">
											    ...
											    <input type="email" class="form-control" name="emailSignin">
                                                                                            <span><font color ="red"><?php if (isset($message) && ($message == "Wrong email")) echo $message; else echo form_error("emailSignin","<font color='red'>","</font>"); ?></font></span>
											  </div>
											  <div class="form-group" style="width:60%">
											    <label for="pwd_signin">Password:</label>
											    <input type="password" class="form-control" name="pwd_signin">
                                                                                            <span><font color = "red"><?php if (isset($message) && ($message == "Wrong password")) echo $message; else echo form_error("pwd_signin","<font color='red'>","</font>"); ?></font></span>
											  </div>
